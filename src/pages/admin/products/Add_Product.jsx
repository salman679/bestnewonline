        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 mb-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-gray-500 dark:text-gray-400">Create a new product with detailed information</p>
            </div>
            <button
              onClick={() => navigate("/all-products")}
              className="flex items-center gap-2 px-6 py-2 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 bg-gray-50 dark:bg-gray-700 rounded-lg transition-all duration-200"
            >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 max-[640px]:p-4">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Fill in the basic details of your product</p>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 max-[640px]:p-4">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Provide a detailed description of your product</p>
              </div>
            </div>
            <ReactQuill
              theme="snow"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 max-[640px]:p-4">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Product Images</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Upload or provide URLs for product images</p>
              </div>
            </div>
                ...
                <div className="space-y-2">
                  ...
                  <TagsInput
                    ...
                    classNames={{
                      ...
                      tagInput: "w-full",
                      tagInputField: "w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200",
                    }}
                  />
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 max-[640px]:p-4">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Provide additional product information</p>
              </div>
            </div>
              ...
              {["discount", "sold", "supplier", "warranty", "shippingCost"].map((field) => (
                <div key={field} className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      className={`w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${["discount", "shippingCost"].includes(field) ? 'pl-8' : ''}`}
                      name={field}
                      placeholder={`Enter ${field.charAt(0).toUpperCase() + field.slice(1)}`}
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Add different versions of your product</p>
                </div>
              </div>
              <button
                type="button"
                    ...
                    {["size", "color", "additionalPrice"].map((field) => (
                      <div key={field} className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <input
                            className={`w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${field === "additionalPrice" ? 'pl-8' : ''}`}
                            name={field}
                            placeholder={`Enter ${field.charAt(0).toUpperCase() + field.slice(1)}`}
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Add technical details and features</p>
                </div>
              </div>
              <button
                type="button"
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Add any other relevant details</p>
                </div>
              </div>
              <button
                type="button"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 max-[640px]:p-4">
            <div className="flex items-center justify-between">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex items-center gap-2 px-8 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-md"
              >
                {loading ? (
                  <>
