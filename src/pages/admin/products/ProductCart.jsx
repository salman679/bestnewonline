          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-blue-600 dark:text-blue-400">
                {product.price}<span className="text-2xl font-bold">৳</span>
              </span>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium text-gray-900 dark:text-white">{product.price}<span className='text-2xl font-bold'>৳</span></span>
                  </div>
                  {product.discount > 0 && (
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 dark:text-gray-300">Discount</span>
                      <span className="font-medium textColor600 dark:textColor">-{product.discount}%</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`font-medium ${product.isStock ? 'text-green-600 dark:text-green-400' : 'textColor600 dark:textColor'}`}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {product.variants.map((variant, index) => (
                      <div key={index} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                        ...
                        <div className="flex justify-between items-center">
                          <span className="text-gray-600 dark:text-gray-300">Price</span>
                          <span className="font-medium text-gray-900 dark:text-white">{variant.price}<span className='text-2xl font-bold'>৳</span></span>
                        </div>
                      </div>
                    ))}
                  </div>
