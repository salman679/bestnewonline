      ...
      <div className="max-w-6xl mx-auto font-[sans-serif] py-10">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">Get professional home services tailored to your needs. From cleaning to repairs, we've got you covered.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">Keep your home safe with trusted security solutions. Enjoy peace of mind with our reliable protection.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">Get 24/7 assistance for all your home service needs. We're here to help anytime, anywhere.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">Enjoy fast and reliable home services, ensuring top-notch performance every time.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">Access trusted home services wherever you are, with our extensive network of professionals.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">Stay connected with our smooth and efficient communication for all your home service needs.</p>
          </div>
        </div>
      </div>
    </>
