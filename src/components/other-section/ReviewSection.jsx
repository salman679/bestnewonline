    ...
    <>
      <div className="my-6 font-[sans-serif] max-w-6xl mx-auto">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-bold max-[640px]:text-xl">What our happy client say</h2>
          <p className="text-sm max-[640px]:px-6 mt-6 leading-relaxed ">Veniam proident aute magna anim excepteur et ex consectetur velit ullamco veniam minim aute sit. Elit occaecat officia et laboris Lorem minim. Officia do aliqua adipisicing ullamco in</p>
        </div>
